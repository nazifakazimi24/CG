...
void main() {
    ...
    if (toon_shading){ // toon shading boolean
        ...
        out_Color[0] = int(out_Color[0]) / layers; // converion to int and then division by total nr of colors for value between 0 and 5
        out_Color[1] = int(out_Color[1]) / layers; // converion to int and then division by total nr of colors for value between 0 and 5
        out_Color[2] = int(out_Color[2]) / layers; // converion to int and then division by total nr of colors for value between 0 and 5
    }
 }
